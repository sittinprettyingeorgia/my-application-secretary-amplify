  ...
  return (
    <Container maxWidth='xl'>
      ...
      <Typography gutterBottom>
        ...
        acknowledge that Company is not responsible for third party access to
      ...
      <Typography>
        ...
        any link does not imply endorsement by Company of the site or any
        association with its operators. Certain services made available via
        https://www.myapplicationsecretary.com are delivered by third party
        sites and organizations. By using any product, service or functionality
        originating from the https://www.myapplicationsecretary.com domain, you
        hereby acknowledge and consent that Company may share such information
        and data with any third party with whom Company has a contractual
        relationship to provide the requested product, service or functionality
        on behalf of https://www.myapplicationsecretary.com users and customers.
        ...
        https://www.myapplicationsecretary.com strictly in accordance with these
        terms of use. As a condition of your use of the Site, you warrant to
        Company that you will not use the Site for any purpose that is unlawful
        ...
        on the Site, is the property of Company or its suppliers and protected
        ...
        any such content and will not make any changes thereto. You will not
        modify, publish, transmit, reverse engineer, participate in the transfer
        or sale, create derivative works, or in any way exploit any of the
        content, in whole or in part, found on the Site. Company content is not
        ...
        permission of Company and the copyright owner. You agree that you do not
        ...
        by Company from our offices within the USA. If you access the Service
        ...
        accessed through https://www.myapplicationsecretary.com in any country
        or in any manner prohibited by any applicable laws, restrictions or
        regulations. Indemnification You agree to indemnify, defend and hold
        harmless Company, its officers, directors, employees, agents and third
        ...
        of or inability to use the Site or services, any user postings made by
      ...
      <Typography gutterBottom>
        ...
        IS&quot; WITHOUT WARRANTY OR CONDITION OF ANY KIND. BLAKE SOFTWARE LLC
        ...
        NON-INFRINGEMENT TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW IN NO
        EVENT SHALL BLAKE SOFT WARE LLC AND/OR ITS SUPPLIERS BE LIABLE FOR ANY
        ...
        LIABILITY OR OTHERWISE. EVEN IF BLAKE SOFTWARE LLC OR ANY OF ITS
        ...
        IS TO DISCONTINUE USING THE SITE Termination/Access Restriction Company
        reserves the right, in its sole discretion, to terminate your access to
        the Site and the related services or any portion thereof at any time,
        ...
        this section. You agree that no joint venture, partnership, employment,
        or agency relationship exists between you and Company as a result of
        this agreement or use of the Site. Company&apos;s performance of this
        agreement is subject to existing laws and legal process, and nothing
        contained in this agreement is in derogation of Company&apos;s right to
        ...
        or gathered by Company with respect to such use. If any part of this
        ...
        the entire agreement between the user and Company with respect to the
        ...
        Company with respect to the Site. A printed version of this agreement
        ...
        and all related documents be written in English. Changes to Terms
        Company reserves the right, in its sole discretion, to change the Terms
