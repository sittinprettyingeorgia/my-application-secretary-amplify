...
export default function AnswerUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = { ...initialValues, ...answerRecord };
    setAnswer(cleanValues.answer);
    setErrors({});
  };
  const [answerRecord, setAnswerRecord] = React.useState(answer);
  React.useEffect(() => {
    const queryData = async () => {
      const record = id ? await DataStore.query(Answer, id) : answer;
