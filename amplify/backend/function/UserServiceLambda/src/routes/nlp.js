...
const themesBeforeDeDupe = [
    ...
    { theme: "clearance", keywords: ["dod security clearance", "obtain and maintain security clearance"] },
    { theme: "contact", keywords: ["method of contact", "contacting me via text message", "receive email notifications"] },
    { theme: "containerization", keywords: ["containerization"] },
    { theme: "country", keywords: ["country"] },
    { theme: "date", keywords: ["date", "today's date"] },
    { theme: "disability", keywords: ["disability", "self-identification of disability"] },
    { theme: "earliestAvailable", keywords: ["earliest available"] },
    { theme: "education", keywords: ["bachelor's degree", "highest education level", "education"] },
    ...
    { theme: "name", keywords: ["name", "full name", "first name", "last name", 'signature'," i certify that answers given herein are true, accurate, and complete to the best of my knowledge."] },
    { theme: "notice", keywords: ["notice employer", "time frame to start new position", "notice to your employer"] },
    { theme: "race", keywords: ["ethnicity", "race", "ethnic background", "race/ethnicity"] },
    { theme: "react", keywords: ["react"] },
    { theme: "referral", keywords: ["referral", "Were you referred by anyone", "person who referred you"] },
    { theme: "salary", keywords: ["compensation", "salary", "desired pay", "desired annual salary"] },
    ...
    { theme: "streetAddress", keywords: ["street address", "address", "home address"] },
  ...
  { theme: "authentication", keywords: ["authentication", "authorization", "OAuth", "OpenID Connect"] },
  { theme: "awsLambda", keywords: ["AWS Lambda", "serverless"] },
  { theme: "backend", keywords: ["backend", "server", "database", "ORM", "SQL", "NoSQL"] },
  { theme: "browser", keywords: ["browser", "HTML", "CSS", "JavaScript"] },
  { theme: "cache", keywords: ["cache", "Redis", "Memcached"] },
  { theme: "cloud", keywords: ["cloud computing", "AWS", "Azure", "Google Cloud"] },
  { theme: "codeQuality", keywords: ["code quality", "linting", "testing", "coverage"] },
  { theme: "codingStyle", keywords: ["coding style", "best practices"] },
  { theme: "communication", keywords: ["communication", "collaboration", "teamwork"] },
  { theme: "containers", keywords: ["containers", "Docker", "Kubernetes"] },
  { theme: "continuousIntegration", keywords: ["continuous integration", "Jenkins", "Travis CI", "CircleCI"] },
  { theme: "crypto", keywords: ["cryptography", "encryption", "hashing"] },
  { theme: "cssFramework", keywords: ["CSS framework", "Bootstrap", "Materialize", "Bulma"] },
  { theme: "dataAnalysis", keywords: ["data analysis", "data visualization", "matplotlib", "D3.js"] },
  { theme: "dataScience", keywords: ["data science", "machine learning", "AI", "deep learning"] },
  { theme: "databaseDesign", keywords: ["database design", "schema", "ER diagram"] },
  { theme: "debugging", keywords: ["debugging", "logging", "error handling"] },
  { theme: "deployment", keywords: ["deployment", "CD/CI", "DevOps"] },
  { theme: "designPatterns", keywords: ["design patterns", "MVC", "Observer", "Singleton"] },
  { theme: "devEnvironment", keywords: ["development environment", "IDE", "text editor", "version control"] },
  { theme: "devOps", keywords: ["DevOps", "AWS DevOps", "Azure DevOps", "Google Cloud DevOps"] },
  { theme: "docker", keywords: ["Docker", "containerization", "Dockerfile"] },
  { theme: "documentation", keywords: ["documentation", "JSDoc", "API reference", "README"] },
  { theme: "ec2", keywords: ["EC2", "Elastic Compute Cloud"] },
  { theme: "elasticSearch", keywords: ["Elasticsearch", "search engine", "indexing"] },
  { theme: "encryption", keywords: ["encryption", "decryption", "cryptography"] },
  { theme: "frontend", keywords: ["frontend", "web development", "React", "Angular", "Vue.js"] },
  { theme: "fullStack", keywords: ["full-stack", "MEAN stack", "MERN stack", "LAMP stack"] },
  ...
  { theme: "artificialIntelligence", keywords: ["artificial intelligence", "ai"] },
  { theme: "azure", keywords: ["azure"] },
  { theme: "bootstrap", keywords: ["bootstrap"] },
  { theme: "c", keywords: ["c"] },
  { theme: "c#", keywords: ["c#"] },
  ...
  { theme: "machineLearning", keywords: ["machine learning", "ai", "artificial intelligence"] },
  ...
  { theme: "microservicesArchitecture", keywords: ["microservices architecture"] },
  ...
  { theme: "naturalLanguageProcessing", keywords: ["natural language processing", "nlp"] },
  { theme: "name", keywords: ["name", "full name", "first name", "last name", 'signature'," i certify that answers given herein are true, accurate, and complete to the best of my knowledge."] },
  ...
  { theme: "performance", keywords: ["performance evaluation", "performance review"] },
  { theme: "personalInfo", keywords: ["personal information", "personal data"] },
  ...
  { theme: "pregnancy", keywords: ["pregnancy", "pregnant", "maternity leave"] },
  ...
  { theme: "serverless", keywords: ["serverless"] },
  { theme: "softwareTesting", keywords: ["software testing", "automated testing", "manual testing"] },
  ...
  { theme: "api", keywords: ["api", "rest", "graphql"] },
  { theme: "architecture", keywords: ["software architecture", "microservices", "service-oriented architecture"] },
  { theme: "aws", keywords: ["aws", "amazon web services"] },
  { theme: "azure", keywords: ["azure", "microsoft azure"] },
  { theme: "backend", keywords: ["backend development", "server-side programming"] },
  ...
  { theme: "communication", keywords: ["communication", "listening", "verbal communication"] },
  { theme: "computerScience", keywords: ["computer science", "computational thinking"] },
  { theme: "containers", keywords: ["docker", "kubernetes", "containerization"] },
  { theme: "css", keywords: ["css", "cascading style sheets"] },
  { theme: "dataAnalysis", keywords: ["data analysis", "data visualization", "pandas"] },
  { theme: "dataScience", keywords: ["data science", "machine learning", "deep learning"] },
  { theme: "database", keywords: ["database", "sql", "nosql"] },
  { theme: "debugging", keywords: ["debugging", "troubleshooting"] },
  { theme: "devOps", keywords: ["devops", "continuous integration", "continuous delivery"] },
  { theme: "django", keywords: ["django", "python web framework"] },
  { theme: "docker", keywords: ["docker", "containerization"] },
  { theme: "frontend", keywords: ["frontend development", "client-side programming"] },
  { theme: "fullStack", keywords: ["full stack development", "web development"] },
  ...
  { theme: "machineLearning", keywords: ["machine learning", "artificial intelligence"] },
  { theme: "mongodb", keywords: ["mongodb", "document-oriented database"] },
  { theme: "Agile development", keywords: ["agile development", "scrum"] },
  { theme: "Algorithm design", keywords: ["algorithm design", "data structures"] },
  { theme: "AWS", keywords: ["aws", "amazon web services"] },
  ...
  { theme: "CI/CD", keywords: ["continuous integration", "continuous deployment", "ci/cd"] },
  { theme: "Cloud computing", keywords: ["cloud computing", "cloud architecture"] },
  ...
  { theme: "Computer networks", keywords: ["computer networks", "network protocols"] },
  { theme: "Concurrency", keywords: ["concurrency", "multithreading"] },
  { theme: "CSS", keywords: ["css", "cascading style sheets"] },
  { theme: "Data analysis", keywords: ["data analysis", "data visualization"] },
  { theme: "Database design", keywords: ["database design", "database management"] },
  { theme: "Debugging", keywords: ["debugging", "troubleshooting"] },
  { theme: "Design patterns", keywords: ["design patterns", "object-oriented design"] },
  { theme: "DevOps", keywords: ["devops", "site reliability engineering"] },
  { theme: "Distributed systems", keywords: ["distributed systems", "distributed computing"] },
  { theme: "Django", keywords: ["django", "python web framework"] },
  { theme: "Documentation", keywords: ["documentation", "technical writing"] },
  { theme: "Docker", keywords: ["docker", "containerization"] },
  { theme: "Encryption", keywords: ["encryption", "cryptography"] },
  { theme: "Frontend development", keywords: ["frontend development", "javascript frameworks"] },
  ...
  { theme: "Machine learning", keywords: ["machine learning", "artificial intelligence"] },
  { theme: "Microservices", keywords: ["microservices", "service-oriented architecture"] },
  { theme: "Mobile development", keywords: ["mobile development", "react native"] },
  { theme: "MongoDB", keywords: ["mongodb", "nosql"] },
  { theme: "React", keywords: ["React", "React.js", "ReactJS", "React Native", "ReactNative"] },
  { theme: "Vue.js", keywords: ["Vue", "Vue.js", "VueJS"] },
  { theme: "Angular", keywords: ["Angular", "Angular.js", "AngularJS", "Angular 2", "Angular 4", "Angular 6", "Angular 8", "Angular 10"] },
  { theme: "JavaScript", keywords: ["JavaScript", "ES6", "ES2015", "ES2016", "ES2017", "ES2018", "ES2019", "ES2020"] },
  { theme: "HTML", keywords: ["HTML", "HTML5", "Markup"] },
  { theme: "CSS", keywords: ["CSS", "CSS3", "Sass", "Less", "Bootstrap", "Tailwind", "Styled Components"] },
  { theme: "Responsive Design", keywords: ["Responsive Design", "Responsive Web Design", "Mobile-first Design"] },
  { theme: "Webpack", keywords: ["Webpack", "Webpack 4", "Webpack 5"] },
  { theme: "Babel", keywords: ["Babel", "Babel 7", "Babel 8"] },
  { theme: "TypeScript", keywords: ["TypeScript"] },
  { theme: "Redux", keywords: ["Redux", "React-Redux", "Redux Saga", "Redux Thunk"] },
  { theme: "GraphQL", keywords: ["GraphQL"] },
  { theme: "REST API", keywords: ["REST API", "RESTful API"] },
  { theme: "Responsive Images", keywords: ["Responsive Images", "Responsive Images in HTML", "Responsive Images in CSS"] },
  { theme: "Progressive Web Apps", keywords: ["Progressive Web Apps", "PWA", "Service Workers"] },
  { theme: "Accessibility", keywords: ["Accessibility", "WCAG", "ARIA", "Screen Readers", "Keyboard Navigation"] },
  { theme: "Cross-Browser Compatibility", keywords: ["Cross-Browser Compatibility", "Browser Compatibility"] },
  { theme: "Performance Optimization", keywords: ["Performance Optimization", "Web Performance", "Page Speed"] },
  { theme: "Unit Testing", keywords: ["Unit Testing", "Jest", "Mocha", "Chai"] },
  { theme: "Integration Testing", keywords: ["Integration Testing", "Cypress", "Selenium"] },
  { theme: "End-to-End Testing", keywords: ["End-to-End Testing", "E2E Testing", "TestCafe", "Nightwatch"] },
  { theme: "Debugging", keywords: ["Debugging", "Chrome DevTools", "Firefox DevTools"] },
  { theme: "Git", keywords: ["Git", "Version Control"] },
  { theme: "Agile", keywords: ["Agile", "Scrum", "Kanban"] },
  { theme: "Pair Programming", keywords: ["Pair Programming"] },
  { theme: "Code Review", keywords: ["Code Review"] },
  { theme: "Continuous Integration", keywords: ["Continuous Integration", "CI/CD"] },
  { theme: "MVC Architecture", keywords: ["MVC", "MVC Architecture", "Model View Controller"] },
  { theme: "MVVM Architecture", keywords: ["MVVM", "MVVM Architecture", "Model View ViewModel"] },
  ...
  { theme: "CI/CD", keywords: ["ci/cd", "continuous integration", "continuous deployment"] },
  { theme: "Unit Testing", keywords: ["unit testing", "test-driven development", "tdd"] },
  ...
  { theme: "C programming", keywords: ["embedded C programming", "microcontroller programming", "firmware development"] },
  { theme: "Assembly language", keywords: ["assembly programming", "assembly language development", "low-level programming"] },
  { theme: "RTOS", keywords: ["real-time operating system", "RTOS kernel", "RTOS scheduling"] },
  { theme: "Embedded systems", keywords: ["embedded systems development", "embedded hardware design", "embedded software design"] },
  { theme: "Device drivers", keywords: ["device driver development", "device driver programming", "driver interface"] },
  { theme: "Interrupts", keywords: ["interrupt handling", "interrupt service routines", "hardware interrupts"] },
  { theme: "ARM Cortex-M", keywords: ["ARM Cortex-M programming", "ARM Cortex-M microcontrollers", "ARM CMSIS"] },
  { theme: "Debugging", keywords: ["embedded debugging", "low-level debugging", "debugging hardware"] },
  { theme: "Bare-metal programming", keywords: ["bare-metal programming", "bare-metal development", "bare-metal firmware"] },
  { theme: "SPI", keywords: ["SPI protocol", "SPI bus", "SPI communication"] },
  { theme: "I2C", keywords: ["I2C protocol", "I2C bus", "I2C communication"] },
  { theme: "UART", keywords: ["UART protocol", "UART communication", "UART interface"] },
  { theme: "CAN", keywords: ["CAN protocol", "CAN bus", "CAN communication"] },
  { theme: "Wireless communication", keywords: ["wireless communication protocols", "RF communication", "Bluetooth programming"] },
  { theme: "Low-power design", keywords: ["low-power embedded systems", "low-power hardware design", "power optimization"] },
  { theme: "FPGA", keywords: ["FPGA development", "FPGA programming", "VHDL"] },
  { theme: "ASIC design", keywords: ["ASIC development", "ASIC programming", "ASIC verification"] },
  { theme: "Signal processing", keywords: ["embedded signal processing", "DSP programming", "filter design"] },
  { theme: "Sensor integration", keywords: ["sensor interfacing", "sensor fusion", "sensor calibration"] },
  { theme: "Control systems", keywords: ["embedded control systems", "feedback control", "PID controllers"] },
  { theme: "Real-time simulations", keywords: ["real-time simulation development", "hardware-in-the-loop testing", "closed-loop control systems"] },
  { theme: "Hardware design", keywords: ["hardware development", "digital design", "analog design"] },
  { theme: "VLSI design", keywords: ["VLSI development", "VLSI programming", "ASIC design flow"] },
  { theme: "PCB design", keywords: ["PCB layout", "PCB design software", "high-speed PCB design"] },
  { theme: "Power electronics", keywords: ["power electronics design", "power converter design", "power management ICs"] },
  { theme: "EMC compliance", keywords: ["EMC testing", "EMC standards", "EMC design considerations"] },
